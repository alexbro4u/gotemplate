...
import (
	...
	uow "github.com/alexbro4u/uowkit/uow"
...
func (_m *MockUnitOfWork) Do(ctx context.Context, fn func(uow.Tx) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(uow.Tx) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockUnitOfWork_Do_Call) Run(run func(ctx context.Context, fn func(uow.Tx) error)) *MockUnitOfWork_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(uow.Tx) error))
	})
	return _c
}
...
func (_c *MockUnitOfWork_Do_Call) RunAndReturn(run func(context.Context, func(uow.Tx) error) error) *MockUnitOfWork_Do_Call {
	_c.Call.Return(run)
	return _c
}
